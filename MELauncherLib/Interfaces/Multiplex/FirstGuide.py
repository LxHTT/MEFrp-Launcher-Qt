...
class GuideInterface(QWidget, GuideAPI):
    ...
    def setupText(self):
        ...
        self.accountTip.setText("使用 ME Frp 账户登录以使用此启动器的所有功能。")
        self.noAccountBtn.setText("我还没有 ME Frp 账户")
        self.hasAccountBtn.setText("我已有 ME Frp 账户")
        self.accountText.setText("ME Frp 账户")
        ...
        self.loginText.setText("登录 ME Frp 账户")
        self.forgotEmailEdit.setLabel("邮箱地址")
        self.forgotPwdText.setText("找回 ME Frp 账户")
        ...
        self.registerText.setText("注册 ME Frp 账户")
